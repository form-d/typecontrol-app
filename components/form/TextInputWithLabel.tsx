  ...
  return (
    <Container {...wrapperProps}>
      <input
        ...
        className={`${
          block ? "w-full" : ""
        } h-8 bg-white border border-gray-300 rounded-lg py-2 px-4 text-gray-900 text-sm leading-tight focus:outline-hidden focus:bg-white focus:border-purple-500 ${className}`}
        value={value}
