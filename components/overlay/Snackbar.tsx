...
export const Snackbar: React.FC = () => {
  ...
  const baseClasses =
    "fixed z-15 bottom-4 w-auto max-w-[calc(100vw-theme(space.4))] md:max-w-sm left-1/2 transform -translate-x-1/2 px-6 py-3 text-sm md:text-base text-center rounded-lg shadow-lg";
