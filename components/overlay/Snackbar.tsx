...
export const Snackbar: React.FC = () => {
  ...
  const baseClasses =
    "fixed z-15 bottom-4 max-w-sm w-[calc(100%-theme(space.7))] left-1/2 transform -translate-x-1/2 px-6 py-3 text-sm md:text-base text-center rounded-lg shadow-lg";
  const colorClasses =
